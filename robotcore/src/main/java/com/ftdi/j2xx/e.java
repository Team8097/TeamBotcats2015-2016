...
class e extends k
{
    ...
    short a(final FT_EEPROM ft_EEPROM) {
        ...
        try {
            ...
            final int n = this.a(ft_EEPROM.Product, array, this.a(ft_EEPROM.Manufacturer, array, 10, 7, true) + (ft_EEPROM.Manufacturer.length() + 2), 8, true) + (ft_EEPROM.Product.length() + 2);
            if (ft_EEPROM.SerNumEnable) {
                final int n2 = this.a(ft_EEPROM.SerialNumber, array, n, 9, true) + (ft_EEPROM.SerialNumber.length() + 2);
            }
