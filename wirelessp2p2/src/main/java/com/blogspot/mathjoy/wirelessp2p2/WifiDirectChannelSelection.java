...
package com.blogspot.mathjoy.wirelessp2p2;
...
public class WifiDirectChannelSelection
{
    ...
    public WifiDirectChannelSelection(final Context context, final WifiManager wifiManager) {
    ...
    public void config(final int wifiClass, final int wifiChannel) throws IOException {
        try {
